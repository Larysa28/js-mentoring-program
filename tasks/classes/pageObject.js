 ...
 * 3. Inside the ./tasks/classes/test folder create a file with the name first-e2e-test.spec.js
 ...
 *    9) Also run test from terminal using command npx playwright test first-e2e-test.spec.js
